...
class Order(db.Model):
    ...
    cardnumber = db.Column(db.String(64))  # avoid storing raw card data in production
...
def submit_order():
    ...
    try:
        ...
        db.session.rollback()
        print("ORDER INSERT ERROR:", repr(e))
        return jsonify({"status": "error", "message": "Order failed", "error": str(e)}), 500
